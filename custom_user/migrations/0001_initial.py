    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('type_of_user', models.CharField(choices=[('C', 'Client'), ('A', 'Administrator'), ('S', 'Supplier')], default='A', max_length=1)),
                ...
                ('basic_user', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.PROTECT, to='basic_user.basicuser')),
