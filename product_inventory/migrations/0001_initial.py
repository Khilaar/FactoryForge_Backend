    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('name', models.CharField(default='product_inventory', max_length=250)),
                ('description', models.TextField(blank=True, default='This inventory holds all your finished products.', null=True)),
